...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('pool', 'varDiffVariance', '20', 'int', 'Vardiff retarget deadband in percent (20 == legacy 0.2): a new difficulty within this percent of the current one is not pushed.');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('email', 'remoteShareStalePendingSubject', 'FYI: Pending blocks not verified for over a month', 'string', 'Subject of remote_share stale pending block admin email');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('email', 'remoteShareStalePendingBody', 'remote_share has %(count)s pending block(s) older than %(age_days)s days.\n\n%(jobs)s\n\nPlease verify wallet/daemon sync and pending_blocks.', 'string', 'Body of remote_share stale pending block admin email');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('email', 'statsDaemonFailBody', 'The worker failed to return last block header for %(port)s port. Error detail: %(error)s. Please verify if the daemon or merged-mining relay is running properly.', 'string', 'Body of pool_stats daemon failure admin email');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('email', 'longRunnerCleanSubject', 'long_runner share history retention warning', 'string', 'Subject of long_runner cleanup warning admin email');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('email', 'longRunnerCleanBody', 'long_runner is retaining share history spanning %(blocks)s block heights to protect pending payouts. Oldest locked height: %(oldest_locked_height)s; current height: %(current_height)s.', 'string', 'Body of long_runner cleanup warning admin email');
