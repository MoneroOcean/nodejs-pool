...
# Use the bundled helper for repository checkouts. Curl-pipe installs do not
# have a trustworthy source path, so fetch it into a private temporary file.
...
validate_positive_integer "$TARI_PEER_PURGE_INTERVAL_SECONDS" TARI_PEER_PURGE_INTERVAL_SECONDS
...
write_tari_merge_mining_service "$xtm_mm_dependency_units"
