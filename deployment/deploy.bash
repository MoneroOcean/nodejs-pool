...
sudo -u monerodaemon /usr/local/src/monero/build/release/bin/monero-blockchain-import --input-file $BLOCKCHAIN_DOWNLOAD_DIR/blockchain.raw --batch-size 20000 --guard-against-pwnage 0 --data-dir /home/monerodaemon/.bitmonero
...
cd ~
sudo env PATH=$PATH:`pwd`/.nvm/versions/node/v8.11.2/bin `pwd`/.nvm/versions/node/v8.11.2/lib/node_modules/pm2/bin/pm2 startup systemd -u $USER --hp `pwd`
cd ~/nodejs-pool
