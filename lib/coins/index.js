...
/** @typedef {{jsonInput: Record<string, unknown>, cb: (result: unknown, errorKind?: string) => void, time: number, miner_address: string, mode?: "pearl"}} VerifyTask */
...
function Coin(data) {
    ...
    this.verifyPearlAsync = function verifyPearlAsync(header, proof, target, miner_address, cb) {
        ...
        if (!bestQueue) {
            decrementMinerAddressVerify(miner_address);
