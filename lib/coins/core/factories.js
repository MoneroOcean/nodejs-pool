...
function createEthUncleReward(config, canonicalBlock, uncleBlock) {
    ...
    return (baseReward * (8 - (parseInt(canonicalBlock.number, 10) - parseInt(uncleBlock.number, 10))) / 8) * rewardMultiplier;
}
...
function createBtcRpc(overrides) {
    ...
    config.getBlockHeaderById = function getBlockHeaderById(ctx) {
        ctx.runtime.support.rpcPortDaemon2(ctx.port, "", { method: "getblockhash", params: [ctx.blockId] }, function onHash(body) {
            if (!body || !body.result) return ctx.callback(true, body);
            return ctx.runtime.coinFuncs.getPortAnyBlockHeaderByHash(ctx.port, body.result, false, ctx.callback);
        });
    };
    ...
    config.getBlockTemplate = function getBlockTemplate(ctx) {
        ctx.runtime.support.rpcPortDaemon2(ctx.port, "", { method: "getblocktemplate", params: [{ capabilities: ["coinbasetxn", "workid", "coinbase/append"], rules: ["segwit"] }] }, function onTemplate(body) {
            ...
            return ctx.callback(config.createBlockTemplate(ctx.runtime.cnUtil, body.result, ctx.runtime.getPoolAddress(ctx.profile)));
        });
    };
...
function createEthRpc(overrides) {
    ...
    config.getBlockHeaderById = function getBlockHeaderById(ctx) {
        ...
        ctx.runtime.support.rpcPortDaemon2(ctx.port, "", { jsonrpc: "2.0", id: 1, method: "eth_getBlockByNumber", params: [blockId, true] }, function onBlock(body) {
            if (!body || !body.result) return ctx.callback(true, body);
            body.result.height = parseInt(body.result.number, 10);
            if (ctx.blockId === "latest") return ctx.callback(null, body.result);
            return loadEthBlockReward(ctx.port, body.result, ctx.runtime, ctx.callback);
        });
    };
    ...
    config.getAnyBlockHeaderByHash = function getAnyBlockHeaderByHash(ctx) {
        ctx.runtime.support.rpcPortDaemon2(ctx.port, "", { jsonrpc: "2.0", id: 1, method: "eth_getBlockByHash", params: ["0x" + ctx.blockHash, true] }, function onBlock(body) {
            ...
            ctx.runtime.coinFuncs.getPortBlockHeaderByID(ctx.port, body.result.height, function onCanonical(err, canonical) {
                if (err) return ctx.callback(true, body);
                if (body.result.hash === canonical.hash) return loadEthBlockReward(ctx.port, body.result, ctx.runtime, ctx.callback);

                ctx.runtime.async.eachSeries(Array(16).fill().map(function mapHeight(_value, index) {
                    return body.result.height + index - 7;
                }), function eachHeight(blockHeight, next) {
                    ctx.runtime.coinFuncs.getPortBlockHeaderByID(ctx.port, blockHeight, function onHeader(err2, blockHeader) {
                        if (err2) {
                            if (ctx.isOurBlock) return next(false);
                            return next(null);
                        }
                        ...
                        ctx.runtime.support.rpcPortDaemon2(ctx.port, "", { jsonrpc: "2.0", id: 1, method: "eth_getUncleByBlockNumberAndIndex", params: ["0x" + blockHeight.toString(16), "0x" + uncleIndex.toString(16)] }, function onUncle(bodyUncle) {
                            if (!bodyUncle || !bodyUncle.result) return next(null);
                            return next(createEthUncleReward(config, blockHeader, bodyUncle.result));
                        });
                    });
                }, function onDone(uncleReward) {
                    if (uncleReward === false) return ctx.callback(true, body);
                    body.result.reward = uncleReward ? uncleReward : null;
                    return ctx.callback(null, body.result);
                });
            });
        });
    };
    ...
    config.getLastBlockHeader = function getLastBlockHeader(ctx) {
        ctx.runtime.support.rpcPortDaemon2(ctx.port, "", { jsonrpc: "2.0", id: 1, method: "eth_getWork", params: [] }, function onWork(body) {
            ...
            const bt = ctx.runtime.cnUtil.EthBlockTemplate(body.result);
    ...
    config.getBlockTemplate = function getBlockTemplate(ctx) {
        ctx.runtime.support.rpcPortDaemon2(ctx.port, "", { jsonrpc: "2.0", id: 1, method: "eth_getWork", params: [] }, function onWork(body) {
            return ctx.callback(body && body.result ? ctx.runtime.cnUtil.EthBlockTemplate(body.result) : null);
        });
    };
...
function createErgRpc(overrides) {
    ...
    config.getBlockHeaderById = function getBlockHeaderById(ctx) {
        ctx.runtime.support.rpcPortDaemon2(ctx.port, "blocks/at/" + ctx.blockId, null, function onHeight(body) {
            ...
            return ctx.runtime.coinFuncs.getPortAnyBlockHeaderByHash(ctx.port, body[0], false, ctx.callback);
        });
    };
    ...
    config.getLastBlockHeader = function getLastBlockHeader(ctx) {
        ctx.runtime.support.rpcPortDaemon2(ctx.port, "mining/candidate", null, function onCandidate(body) {
            ...
            const bt = ctx.runtime.cnUtil.ErgBlockTemplate(body);
    ...
    config.getBlockTemplate = function getBlockTemplate(ctx) {
        ctx.runtime.support.rpcPortDaemon2(ctx.port, "mining/candidate", null, function onCandidate(body) {
            return ctx.callback(body && body.pk ? ctx.runtime.cnUtil.ErgBlockTemplate(body) : null);
        });
    };
...
const blob = {
    cryptonote(overrides) {
        return createBlob({
            ...
            proofSize: 32,
            convert(ctx) {
                return ctx.runtime.cnUtil.convert_blob(ctx.blobBuffer, ctx.profile.blobType);
            },
            construct(ctx) {
                return ctx.runtime.cnUtil.construct_block_blob(ctx.blockTemplateBuffer, Buffer.from(ctx.params.nonce, "hex"), ctx.profile.blobType);
            },
            getBlockId(ctx) {
                return ctx.runtime.cnUtil.get_block_id(ctx.blockBuffer, ctx.profile.blobType);
            }
        }, overrides);
    },
    identity(overrides) {
    ...
    grin(overrides) {
        return createBlob({
            ...
            construct(ctx) {
                return ctx.runtime.cnUtil.construct_block_blob(
    ...
    dero(overrides) {
        return createBlob({
            ...
            construct(ctx) {
                return ctx.runtime.cnUtil.constructNewDeroBlob(ctx.blockTemplateBuffer, Buffer.from(ctx.params.nonce, "hex"));
            },
            getBlockId(ctx) {
                return ctx.runtime.cnUtil.get_block_id(ctx.blockBuffer, ctx.profile.blobType);
            }
    ...
    raven(overrides) {
        return createBlob({
            ...
            proofSize: 32,
            convert(ctx) {
                return ctx.runtime.cnUtil.convertRavenBlob(ctx.blobBuffer);
            },
            construct(ctx) {
                return ctx.runtime.cnUtil.constructNewRavenBlob(
                    ctx.blockTemplateBuffer,
    ...
    rtm(overrides) {
        return createBlob({
            ...
            proofSize: 32,
            convert(ctx) {
                return ctx.runtime.cnUtil.convertRtmBlob(ctx.blobBuffer);
            },
            construct(ctx) {
                return ctx.runtime.cnUtil.constructNewRtmBlob(ctx.blockTemplateBuffer, Buffer.from(ctx.params.nonce, "hex"));
            },
            getBlockId(ctx) {
                return ctx.runtime.cnUtil.blockHashBuff(ctx.runtime.cnUtil.convertRtmBlob(ctx.blockBuffer));
            }
        }, overrides);
    },
    kcn(overrides) {
        return createBlob({
            ...
            proofSize: 32,
            convert(ctx) {
                return ctx.runtime.cnUtil.convertKcnBlob(ctx.blobBuffer);
            },
            construct(ctx) {
                return ctx.runtime.cnUtil.constructNewKcnBlob(ctx.blockTemplateBuffer, Buffer.from(ctx.params.nonce, "hex"));
            },
            getBlockId(ctx) {
                return ctx.runtime.cnUtil.blockHashBuff3(ctx.runtime.cnUtil.convertKcnBlob(ctx.blockBuffer));
            }
        }, overrides);
    }
};
...
const pow = {
    randomx(overrides) {
        return createPow({
            ...
            hashBuff(ctx) {
                return ctx.runtime.multiHashing.randomx(ctx.convertedBlob, Buffer.from(ctx.blockTemplate.seed_hash, "hex"), this.variant);
            }
        }, overrides);
    },
    cryptonight(overrides) {
        return createPow({
            ...
            hashBuff(ctx) {
                if (this.useHeight) return ctx.runtime.multiHashing.cryptonight(ctx.convertedBlob, this.variant, ctx.blockTemplate.height);
                return ctx.runtime.multiHashing.cryptonight(ctx.convertedBlob, this.variant);
            }
        }, overrides);
    },
    cryptonightHeavy(overrides) {
        return createPow({
            variant: 0,
            verifyInput(ctx) {
            ...
            hashBuff(ctx) {
                return ctx.runtime.multiHashing.cryptonight_heavy(ctx.convertedBlob, this.variant);
            }
        }, overrides);
    },
    cryptonightPico(overrides) {
        return createPow({
            variant: 0,
            verifyInput(ctx) {
                return buildVerifyInput(ctx.algo, ctx.convertedBlob);
            ...
            hashBuff(ctx) {
                return ctx.runtime.multiHashing.cryptonight_pico(ctx.convertedBlob, this.variant);
            }
        }, overrides);
    },
    argon2(overrides) {
        return createPow({
            ...
            hashBuff(ctx) {
                return ctx.runtime.multiHashing.argon2(ctx.convertedBlob, this.variant);
            }
        }, overrides);
    },
    kawpow(overrides) {
        return createPow({
            ...
            hashBuff(ctx) {
                return ctx.runtime.multiHashing.kawpow(ctx.convertedBlob, Buffer.from(ctx.nonce, "hex"), Buffer.from(ctx.mixhash, "hex"));
            }
        }, overrides);
    },
    ethash(overrides) {
        return createPow({
            ...
            hashBuff(ctx) {
                return ctx.runtime.multiHashing.ethash(ctx.convertedBlob, Buffer.from(ctx.nonce, "hex"), ctx.blockTemplate.height);
            }
        }, overrides);
    },
    etchash(overrides) {
        return createPow({
            ...
            hashBuff(ctx) {
                return ctx.runtime.multiHashing.etchash(ctx.convertedBlob, Buffer.from(ctx.nonce, "hex"), ctx.blockTemplate.height);
            }
        }, overrides);
    },
    autolykos2(overrides) {
        return createPow({
            verifyInput(ctx) {
                return buildVerifyInput(ctx.algo, ctx.convertedBlob);
            },
            hashBuff(ctx) {
                return ctx.runtime.multiHashing.autolykos2_hashes(ctx.convertedBlob, ctx.blockTemplate.height);
            }
        }, overrides);
    },
    astrobwt(overrides) {
        return createPow({
            ...
            hashBuff(ctx) {
                return ctx.runtime.multiHashing.astrobwt(ctx.convertedBlob, this.variant);
            }
        }, overrides);
    },
    c29(overrides) {
        return createPow({
            c29(ctx) {
                return ctx.runtime.multiHashing.c29(ctx.header, ctx.ring);
            },
            packEdges(ctx) {
                return ctx.runtime.multiHashing.c29_packed_edges(ctx.ring);
            }
        }, overrides);
    },
    c29v(overrides) {
        return createPow({
            c29(ctx) {
                return ctx.runtime.multiHashing.c29v(ctx.header, ctx.ring);
            },
            packEdges(ctx) {
                return ctx.runtime.multiHashing.c29s_packed_edges(ctx.ring);
            }
        }, overrides);
    },
    c29b(overrides) {
        return createPow({
            c29(ctx) {
                return ctx.runtime.multiHashing.c29b(ctx.header, ctx.ring);
            },
            packEdges(ctx) {
                return ctx.runtime.multiHashing.c29b_packed_edges(ctx.ring);
            }
        }, overrides);
    },
    c29s(overrides) {
        return createPow({
            c29(ctx) {
                return ctx.runtime.multiHashing.c29s(ctx.header, ctx.ring);
            },
            packEdges(ctx) {
                return ctx.runtime.multiHashing.c29s_packed_edges(ctx.ring);
            }
...
pool.submitAccept = Object.freeze({
    definedResult: acceptDefinedResult,
    statusOkObject: acceptStatusOkObject,
    nonRejectedResponse: acceptNonRejectedResponse,
    accepted202String: acceptAccepted202String
});
pool.blockHash = Object.freeze({
    default: resolveDefaultSubmittedBlockHash,
    deroBlid: resolveDeroSubmittedBlockHash,
    resultHash: resolveResultHashSubmittedBlockHash,
    ergHeader: resolveErgSubmittedBlockHash,
    ethFind: resolveEthSubmittedBlockHash,
    xtmRpcHash: resolveXtmSubmittedBlockHash
});
pool.blockSubmit = Object.freeze({
    cryptonote: submitCryptonoteBlock,
...
const btcTemplate = {
    raven(cnUtil, result, poolAddress) {
        return cnUtil.RavenBlockTemplate(result, poolAddress);
    },
    rtm(cnUtil, result, poolAddress) {
        return cnUtil.RtmBlockTemplate(result, poolAddress);
    }
};
