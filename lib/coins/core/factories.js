...
/** @template {{timestamp: number, difficulty: number}} T @param {T} header */
...
/** @param {import("../../../types/coin_profiles").RpcSettings} config @param {number} port @param {import("../../../types/coin_profiles").EthRewardBlock} block @param {import("../../../types/coin_profiles").ProfileRuntime} runtime @param {import("../../../types/coin_profiles").RawReplyCallback} callback */
