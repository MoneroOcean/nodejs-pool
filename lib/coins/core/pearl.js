...
/** @param {unknown} value @returns {{valid: false}|{valid: true, solution_id: string, candidate: boolean, jackpot: string, config: Record<string, unknown> & {adjustment_factor: number}, proof_id?: string}|null} */
