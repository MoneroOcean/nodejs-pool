...
function getMiningInfo(ctx, callback) {
    pearl.gatewayRequest("getMiningInfo", {}, function onMiningInfo(error, body) {
        ...
        ctx.runtime.support.rpcPortDaemon2(ctx.port, "", { method: "getblockheader", params: [parsed.prevHash, true] }, function onPreviousHeader(reply) {
...
function createPearlRpc(config) {
    ...
    config.getBlockHeaderById = function getBlockHeaderById(ctx) {
        ...
        return ctx.runtime.support.rpcPortDaemon2(ctx.port, "", { method: "getblockhash", params: [height] }, function onHash(body) {
            ...
            return ctx.runtime.support.rpcPortDaemon2(ctx.port, "", { method: "getblockheader", params: [hashResult, true] }, function onHeader(headerBody) {
    ...
    config.getAnyBlockHeaderByHash = function getAnyBlockHeaderByHash(ctx) {
        ...
        return ctx.runtime.support.rpcPortDaemon2(ctx.port, "", { method: "getblockheader", params: [hash, true] }, function onHeader(body) {
...
function buildPearlJobPayload(ctx) {
    ...
    if (typeof incompleteHeader !== "string" || typeof ctx.blockTemplate.cert_version !== "number") {
    ...
    return {
        header: ctx.blockTemplate.header,
