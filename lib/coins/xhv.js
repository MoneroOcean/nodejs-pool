...
module.exports = preset.cryptonoteGetBlock({ port: 17750, coin: "XHV", blobType: 11, algo: "cn-heavy/xhv", blobTypeName: "cryptonote_xhv",
    minerAlgoAliases: { "cn-heavy/0": ["cn-heavy"] },
    agent: {
        noSupportRules: [
            {
                matcher: "xmrig",
