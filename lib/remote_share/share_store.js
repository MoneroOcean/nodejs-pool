...
function isStorableShare(share) {
    return Number.isFinite(share.raw_shares) &&
        Number.isInteger(share.blockHeight) &&
        share.blockHeight >= 0 && share.blockHeight <= 0xffffffff;
}
