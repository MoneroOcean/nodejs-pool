 ...
 * @property {number} poolType
 * @property {number} raw_shares
 * @property {number} blockHeight
 * @property {string|null|undefined} [paymentID]
 * @property {number|undefined} [port]
 * @property {number|undefined} [share_num]
 */
 ...
 * @property {DatabaseRuntime} [database]
 */
