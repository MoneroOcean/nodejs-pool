...
/** @typedef {{config: PoolConfig, database: DatabaseRuntime, getCacheValue: (key: string, fallback: unknown) => unknown, now: () => number, query: (sql: string, params?: readonly SqlParam[]) => Promise<SqlRows>, support: SupportRuntime}} PublicCore */
