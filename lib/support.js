...
module.exports = function () {
    return {
        rpcDaemon: bindRpcCall(rpc, function () { return global.config.daemon.address; }, function () { return global.config.daemon.port; }, 30*1000),
        ...
        rpcPortWalletShort2: bindPortRpcCall(rpc2, port_wallet_ip, 30*1000),
