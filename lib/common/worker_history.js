...
/**
 * @param {HistoryPointInput | null | undefined} point
...
/**
 * @param {{head?: number | string | null, size?: number | string | null} | null | undefined} tier
 * @param {number} capacity
...
/**
 * @param {BinaryTierInput | null | undefined} tier
 * @param {number} capacity
...
/**
 * @param {SerializedHistory | null | undefined} payload
...
/**
 * @param {HistoryPointInput[]} points
 * @param {HistoryLayout} layout
 * @returns {History}
 */
