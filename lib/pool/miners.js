...
module.exports = function createMinerFactory(deps) {
    ...
    function buildInitialAlgoState(agent, passAlgoSplit, algos, algosPerf, algoMinTime) {
        ...
        if (Array.isArray(algos) && global.config.daemon.enableAlgoSwitching) {
    ...
    function createMiner(id, login, pass, rigid, ipAddress, startingDiff, pushMessage, protoVersion, portType, port, agent, algos, algosPerf, algoMinTime) {
        ...
        miner.payout = miner.address = (passSplit.length === 3 ? passSplit[2] : loginDotSplit[0]);
        miner.paymentID = null;
        miner.identifier = normalizedAgent && normalizedAgent.includes("MinerGate") ? "MinerGate" : (rigid ? rigid : passSplit[0]).substring(0, 64);
        ...
        miner.setAlgos = function setAlgos(nextAlgos, nextAlgosPerf, nextAlgoMinTime) {
            ...
            if (algoStateChanged && Object.prototype.hasOwnProperty.call(miner, "cachedJob")) {
                ...
                miner.jobLastBlockHash = undefined;
        ...
        miner.proxy = normalizedAgent && normalizedAgent.includes("xmr-node-proxy");
        miner.xmrig_proxy = normalizedAgent && normalizedAgent.includes("xmrig-proxy");
        miner.id = id;
        ...
        if (miner.payout_div !== null) {
            ...
            for (const payout of Object.keys(miner.payout_div).sort()) {
                if (payout !== miner.payout) explicitPayoutDiv[payout] = miner.payout_div[payout];
            }
        ...
        miner.selectBestCoin = function selectBestCoin() {
            ...
            const currentTemplate = typeof miner.curr_coin !== "undefined" ? state.activeBlockTemplates[miner.curr_coin] : null;
            ...
            const currentCoinSupported = typeof miner.curr_coin !== "undefined" && miner.curr_coin in miner.coin_perf && currentTemplate &&
                state.lastCoinHashFactorMM[miner.curr_coin] && global.coinFuncs.isMinerSupportAlgo(currentAlgo, miner.algos);
