"use strict";
const { PEARL_CERT_VERSION } = require("../coins/core/pearl.js");
...
const PEARL_PARAM_FIELDS = new Set([
    "job_id", "plain_proof", "proof_encoding", "jackpot", "adjustment_factor", "cert_version"
]);
...
function isPearlSubmitRequest(value, allowEmptyProof = false) {
    ...
    const certVersion = params["cert_version"];
    return validJobId && typeof proof === "string" && (allowEmptyProof || proof.length > 0) &&
        ...
        (certVersion === undefined || certVersion === PEARL_CERT_VERSION);
}
