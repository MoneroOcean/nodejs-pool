...
module.exports = function createShareProcessor(deps) {
    ...
    function hasBlockSubmitTrust(miner) {
        ...
        return Boolean(miner.validShares || (trustKey in walletTrust && walletTrust[trustKey] > 0));
    }
    ...
    function recordShareData(miner, job, isTrustedShare, blockTemplate) {
        ...
        const wallet = walletAcc[walletKey];
        const workerName = Object.prototype.hasOwnProperty.call(wallet, miner.identifier) || walletWorkerCount[walletKey] < 50
            ? miner.identifier
            : "all_other_workers";
    ...
    function processShare(miner, job, blockTemplate, params, processShareCB) {
        ...
        processShareCB = function finishShareProcessing(shareAccepted) {
            ...
            const resolvedShareAccepted = (isQueuedTrustedShare && shareAccepted === true && isWalletBanned(miner.payout))
                ? null
                : shareAccepted;
            ...
            if (
                (walletVerificationStarted && resolvedShareAccepted === null) ||
                (resolvedShareAccepted === false && hasQueuedGeneration)
            ) {
            ...
            try {
                finalProcessShareCB(resolvedShareAccepted);
            } finally {
        ...
        function verifyBlockCandidate(hashDiff, resultBuff, blockData, convertedBlob, verifyShareCB) {
            ...
            const submitUnverifiedCandidate = function () {
                submitBlock(miner, job, blockTemplate, blockData, resultBuff, hashDiff, false, true, null, function (blockSubmitResult) {
                    ...
                    walletTrust[ensureWalletTrustEntry(miner)] += job.rewarded_difficulty2;
