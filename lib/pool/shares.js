    ...
    function processShare(miner, job, blockTemplate, params, processShareCB) {
        ...
        if (minerWallet) {
            ...
            if (!miner.whiteList && ++minerWallet.last_ver_shares > threshold) {
                ...
                whitelisted: false,
                whitelistSize: Object.keys(ipWhitelist).length,
                addressLength: typeof miner.ipAddress === "string" ? miner.ipAddress.length : -1,
                addressTrimmed: typeof miner.ipAddress === "string" && miner.ipAddress === miner.ipAddress.trim(),
                addressMappedV4: typeof miner.ipAddress === "string" && miner.ipAddress.startsWith("::ffff:")
                });
