...
module.exports = function createProtocolHandler(deps) {
    ...
    function shouldTrackSharedTemplateNonce(blobTypeNum) {
        return global.coinFuncs.blobTypeEth(blobTypeNum) || global.coinFuncs.blobTypeErg(blobTypeNum);
    }
        ...
        case "submit": {
            ...
            const isNonceValid = (function nonceSanityCheck() {
                ...
                if (global.coinFuncs.nonceSize(blobTypeNum) == 8) {
                    ...
                    if (isExtraNonceBT) params.nonce = normalizeExtraNonceSubmitNonce(params.nonce, job.extraNonce);
            ...
            const trackSharedTemplateNonceForShare = shouldTrackSharedTemplateNonce(blobTypeNum);
