...
module.exports = function createProtocolHandler(deps) {
    ...
    // Active jobs and listening ports always resolve to a coin profile with
    // attached pool handlers. If that ever stops being true, failing loudly is
    // better than silently inventing behavior in the protocol layer.
