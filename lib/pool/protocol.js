...
module.exports = function createProtocolHandler(deps) {
    ...
    return function handleMinerData(socket, id, method, params, ip, portData, sendReply, sendReplyFinal, pushMessage, request) {
        ...
        function requestedLoginExtensions() {
            ...
            return SUPPORTED_LOGIN_EXTENSIONS.filter((extension) => params.extensions.includes(extension));
        }
        ...
        function sendLoginJob(miner, minerId) {
            ...
            getPoolSettingsForCoin(coin).sendLoginResult({
                coin,
        ...
        function handleGetJobRequest() {
            ...
            if (miner.mo_native) {
                ...
                if (nativeJob.nativeArray) {
                    miner.sendCoinJob(nativeJob.coin, nativeJob.jobParams, { job: nativeJob.job });
                }
                return;
            }
            sendReply(null, miner.getBestCoinJob());
