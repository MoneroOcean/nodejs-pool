...
function isProtocolParams(value) {
    ...
    for (const [key, field] of Object.entries(value)) {
        if (["login", "pass", "rigid", "agent", "result", "header_hash", "mixhash", "block_submit_test_result", "wallet", "worker", "plain_proof", "proof_encoding"].includes(key)) {
    ...
    return function handleMinerData(socket, id, method, inputParams, ip, portData, sendReply, sendReplyFinal, pushMessage, request) {
        ...
        function normalizeAuthorizeParams() {
            if (!(wireParams instanceof Array)) {
                ...
                // Pearl's standard stratum dialect identifies itself with the
                // wallet/worker/pass object shape before a job can bind the
                // shared-port session to a coin profile.
                if ((!poolSettings || typeof poolSettings.normalizeNamedAuthorizeParams !== "function") &&
                    typeof params.wallet === "string" && typeof params.worker === "string" && typeof params.pass === "string") {
