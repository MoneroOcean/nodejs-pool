...
module.exports = function createMessageHandler(deps) {
    ...
    return function messageHandler(message) {
        ...
        case "sendRemote":
            ...
            break;
        case "trustedShare":
            ++state.shareStats.trustedShares;
            ++state.shareStats.totalShares;
            break;
        case "normalShare":
            ++state.shareStats.normalShares;
            ++state.shareStats.totalShares;
            break;
        case "invalidShare":
            ++state.shareStats.invalidShares;
            ++state.shareStats.totalShares;
            break;
        case "outdatedShare":
            ++state.shareStats.outdatedShares;
            break;
        case "throttledShare":
            ++state.shareStats.throttledShares;
            ++state.shareStats.totalShares;
            break;
        }
    };
