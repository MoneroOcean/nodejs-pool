...
const DEFAULT_ETH_PROXY_SUCCESS_OBSERVE_MS = Number.parseInt(process.env.NODEJS_POOL_LIVE_ETH_PROXY_OBSERVE_MS || "70000", 10);
const DEFAULT_SRBMINER_GPU_ID = "0";
const DEFAULT_SRBMINER_GPU_INTENSITY = process.env.NODEJS_POOL_LIVE_SRBMINER_GPU_INTENSITY || "";
const DEFAULT_SRBMINER_CN_GPU_INTENSITY = process.env.NODEJS_POOL_LIVE_SRBMINER_CN_GPU_INTENSITY
